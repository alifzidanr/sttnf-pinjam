...
<div class="card">
    ...
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <input class="form-control datetime" type="text" name="start_time" id="start_time" value="{{ request()->input('start_time') }}" placeholder="{{ trans('cruds.event.fields.start_time') }}" autocomplete="off" required >
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <input class="form-control datetime" type="text" name="end_time" id="end_time" value="{{ request()->input('end_time') }}" placeholder="{{ trans('cruds.event.fields.end_time') }}" autocomplete="off" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
        ...
        @if($rooms !== null)
            ...
            @else
                <p class="text-center">Tidak ada ruangan yang tersedia dengan waktu tersebut</p>
            @endif
        @endif
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Peminjaman Ruangan</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.bookRoom') }}" method="POST" id="bookingForm">
                    ...
                    {{-- <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" name="location" id="location" value="{{ old('location', '') }}">
                    ...
                    {{-- <div class="form-group">
                        <label for="recurring_until">Berlaku Sampai</label>
...
$('#bookRoom').on('show.bs.modal', function (event) {
    ...
    modal.find('.modal-title').text('Peminjaman Ruangan ' + button.parents('tr').children('.room-name').text());
