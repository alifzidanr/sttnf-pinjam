            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <input class="form-control datetime1" type="text" name="start_time" id="start_time" value="{{ request()->input('start_time') }}" placeholder="{{ trans('cruds.event.fields.start_time') }}" autocomplete="off" required >
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <input class="form-control datetime2" type="text" name="end_time" id="end_time" value="{{ request()->input('end_time') }}" placeholder="{{ trans('cruds.event.fields.end_time') }}" autocomplete="off" required>
                    </div>
                    @if ($errorMessage)
                    <div class="alert alert-primary text-center">{{ $errorMessage }}</div>
                @endif
                </div>
                ...
                {{-- <div class="card-body" style="text-align:center">Jumlah maksimum peserta adalah 20</div> --}}
            </div>
        </form>
        @if($rooms !== null)
            <hr />
            ...
            @else
                <p class="text-center">Tidak ada ruangan yang tersedia</p>
            @endif
        @endif
    </div>
</div>
